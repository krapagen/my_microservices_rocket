...
func (_mock *UserRepository) GetByUUID(ctx context.Context, uuid string) (model.User, error) {
...
func (_c *UserRepository_GetByUUID_Call) RunAndReturn(run func(ctx context.Context, uuid string) (model.User, error)) *UserRepository_GetByUUID_Call {
	_c.Call.Return(run)
	return _c
}
