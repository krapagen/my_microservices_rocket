...
func (_mock *OrderRepository) GetForUpdate(ctx context.Context, orderUUID uuid.UUID) (model.Order, error) {
	ret := _mock.Called(ctx, orderUUID)
...
func (_c *OrderRepository_GetForUpdate_Call) Run(run func(ctx context.Context, orderUUID uuid.UUID)) *OrderRepository_GetForUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrderRepository_GetForUpdate_Call) RunAndReturn(run func(ctx context.Context, orderUUID uuid.UUID) (model.Order, error)) *OrderRepository_GetForUpdate_Call {
	_c.Call.Return(run)
	return _c
}
