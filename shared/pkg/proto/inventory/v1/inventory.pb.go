...
// Ответ на запрос GetPart(информация о детали)
...
// Запрос на получение списка деталей c фильтром по типу и/или UUID
...
// Список деталей, соответствующих фильтру
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBWZUgithub.com/krapagen/my_microservices_rocket/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
